...
// shows weather
//https://api.weather.com/v2/pws/observations/current?stationId=KMAHANOV10&format=json&units=e&apiKey=958b90159b7b40d68b90159b7b50d620
function showWeather() {
    $.ajax({
        url: 'http://api.wunderground.com/api/958b90159b7b40d68b90159b7b50d620/conditions/q/+' + latitude + ',' + longitude + '.json',
        dataType: 'json',
        async: true
    }).done(function(data) {
        if (data) {
